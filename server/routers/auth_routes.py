...
def login_user(
    ...
    if not user.password:
        raise HTTPException(
            status_code=401,
            detail="This account uses Google login. Login with Google first and set a password from Set Password page."
        )
...
def google_login(
    ...
    try:
        ...
        full_name = clean_text(idinfo.get("name", "Google User"))
